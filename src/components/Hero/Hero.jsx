...
export function FlipWordsDemo() {
  ...
  return (
    <div className="text-center p-5 sm:p-8">
            <h1 className="text-4xl p-3 font-medium drop-shadow sm:text-5xl mt-16 ">Making tech <FlipWords words={words} /> for <br />
            <h1 className="sm:pt-5 sm:pb-4 pb-5">underrepresented communities</h1></h1>
